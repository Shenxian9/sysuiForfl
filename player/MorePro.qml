...
Item {
    ...
    Rectangle {
        ...
        z: 10
        x: 5
        y: window.height - scaleFfactor * 180
        ...
        MouseArea {
            ...
            drag.target: parent
            drag.minimumX: 0
            drag.minimumY: window.height / 2
            drag.maximumX: 0
            drag.maximumY: window.height - scaleFfactor * 180
            property int dragY
            onPressed: {
                dragY = parent.y
            }
        ...
        function open() {
            ...
            start_your_pro.y = window.height  / 2
            opened = true
        }

        function close() {
            start_your_pro.y = window.height - scaleFfactor * 180
            opened = false
        }
