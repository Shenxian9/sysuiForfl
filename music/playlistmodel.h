...
class song {
public:
    explicit song(QUrl path, QString title, QString author, QString songName);
...
private:
    QString m_author, m_title, m_songName;
    QUrl m_path;
};
...
public:
    ...
    Q_INVOKABLE bool checkTheAlbumImageIsExists(QUrl file);
    ...
    MP3INFO GetAllInfo(QString filePath);
...
private:
    ...
    void addSong(QUrl path, QString title, QString author, QString songName);
